...
==============================================================================================================================*/
CLine CSimulation::LSmoothCoastSavitzkyGolay(CLine* pLineIn, int const nStartEdge, int const nEndEdge) const
{
   // Note that m_nCoastSmoothWindow must be odd (have already checked this)
   int nHalfWindow = m_nCoastSmoothWindow / 2;
   ...
   for (int i = 0; i < nSize; i++)
   {
      ...
      {
         // For the last few values of VPtTemp, just apply a running mean with a variable-sized window
         int nTmpWindow = 0;
         double dWindowTotX = 0, dWindowTotY = 0;
         for (int j = -nHalfWindow; j < m_nCoastSmoothWindow - nHalfWindow; j++)
         {
      ...
      {
         // For all other VPtTemp values, calc Savitzky-Golay weighted values for both X and Y
...
==============================================================================================================================*/
CLine CSimulation::LSmoothCoastRunningMean(CLine* pLineIn, int const nStartEdge, int const nEndEdge) const
{
   // Note that m_nCoastSmoothWindow must be odd (have already checked this)
   int nHalfWindow = m_nCoastSmoothWindow / 2;
...
vector<double> CSimulation::dVSmoothProfileSlope(vector<double>* pdVSlope)
{
   ...
   int nHalfWindow = m_nProfileSmoothWindow / 2;

   // Make a copy of the unsmoothed profile slope vector
   int nSize = pdVSlope->size();
